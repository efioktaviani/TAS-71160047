...
public class App {
    ...
    public static void main( String[] args ) {
        ...
        final Monster cerberus1 = new Monster("Mike");
        final Monster cerberus2 = new Monster("Clay");
        final Monster manticore1 = new Monster("Ron");
        final Monster manticore2 = new Monster("Pay");
        final Monster cyclops1 = new Monster("Chuck");
        final Monster cyclops2 = new Monster("Jey");
        ...
        monster_namaKamu = new ArrayList<Monster>();
